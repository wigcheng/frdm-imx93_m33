...
void BOARD_InitPins(void) {                                /*!< Function assigned for the core: undefined[cm33] */
    ...
    /* EPD Control PIN*/
    IOMUXC_SetPinMux(IOMUXC_PAD_GPIO_IO00__GPIO2_IO00, 0U); // DC
    IOMUXC_SetPinMux(IOMUXC_PAD_GPIO_IO05__GPIO2_IO05, 0U); // RST
    IOMUXC_SetPinMux(IOMUXC_PAD_GPIO_IO26__GPIO2_IO26, 0U); // BUSY
    /* SPI PIN */
    ...
    IOMUXC_SetPinConfig(IOMUXC_PAD_GPIO_IO00__GPIO2_IO00,
                        ...
                        IOMUXC_PAD_FSEL1(2U) |
                        IOMUXC_PAD_PD_MASK);
    IOMUXC_SetPinConfig(IOMUXC_PAD_GPIO_IO05__GPIO2_IO05,
                        IOMUXC_PAD_DSE(15U) |
                        IOMUXC_PAD_FSEL1(2U) |
                        IOMUXC_PAD_PD_MASK);
